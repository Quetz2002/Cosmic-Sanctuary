...
2. If using HDRP, from package manager, import High Definition Render Pipeline 14.0.10 (U2022.3.24 LTS+)
3. If using URP, from the package manager, import Universal Render Pipeline 14.0.10 or newer (U2022.3.24 LTS+)
4. From the Unity Editor double-click** on either the SSC_URP_[version] or SSC_HDRP_[version] package within this folder
5. TechDemo has its own packages, SSC_TechDemo_URP_[version] or SSC_TechDemo_HDRP_[version]. These require U2022.3.24+ or newer.
6. TechDemo3 has its own packages, SSC_TechDemo3_URP_[version] or SSC_TechDemo3_HDRP_[version]. These require U2022.3.24+ or newer.
