...
namespace SciFiShipController
{
    ...
    public class AutoTargetingModuleEditor : Editor
    {
        ...
        private readonly static GUIContent isTargetsShownOnHUDContent = new GUIContent("Show Targets on HUD", "Show the Targets on the heads-up display. Typically this is only used for player ships or when a ship camera is following a AI ship.");
