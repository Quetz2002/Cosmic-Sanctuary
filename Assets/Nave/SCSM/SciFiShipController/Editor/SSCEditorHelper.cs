...
namespace SciFiShipController
{
    public class SSCEditorHelper
    {
        ...
        public readonly static GUIContent btnNewContent = new GUIContent("New");
        ...
        {
            return DrawSSCCurveWithPreset(0f, curveProperty, curveContent, defaultPreset, buttonCompact, defaultEditorLabelWidth);
        }
        ...
        /// <param name="defaultEditorLabelWidth"></param>
        /// <returns></returns>
        public static bool DrawSSCCurveWithPreset(float indent, SerializedProperty curveProperty, GUIContent curveContent, SSCCurve.CurvePreset defaultPreset, GUIStyle buttonCompact, float defaultEditorLabelWidth)
        {
            bool wasReset = false;
            ...
            if (indent > 0f)
            {
                DrawSSCLabelIndent(indent, new GUIContent("Preset"), defaultEditorLabelWidth - indent - 4f);
            }
            else
            {
                EditorGUILayout.LabelField(" Preset", GUILayout.Width(defaultEditorLabelWidth));
            }
            SSCCurve.CurvePreset curvePreset = (SSCCurve.CurvePreset)EditorGUILayout.EnumPopup(SSCCurve.CurvePreset.None);
            ...
            EditorGUILayout.LabelField(curveContent, GUILayout.Width(labelWidth));
        ...
        {
            if (indent > 0f) { DrawSSCLabelIndent(indent); }
        ...
        {
            EditorGUILayout.BeginHorizontal();
            DrawSSCLabelIndent(indent, guiContent, defaultEditorLabelWidth - (indent > 0 ? indent + 4f : 0f));
            EditorGUILayout.PropertyField(serializedProperty, GUIContent.none);
            EditorGUILayout.EndHorizontal();
        }

        /// <summary>
        /// Draw an indented PropertyField with a label and find button. The action will call the
        /// reset method in the calling class.
        /// DrawSSCPropertyWithFind(0f, handHoldOffsetProp, handHoldOffsetContent, buttonCompact, defaultEditorLabelWidth, ResetHandHoldOffset);
        /// </summary>
        /// <param name="indent"></param>
        /// <param name="serializedProperty"></param>
        /// <param name="guiContent"></param>
        ...
        /// <param name="defaultEditorLabelWidth"></param>
        /// <param name="findAction">The name of the parameter-less function to call when find</param>
        public static void DrawSSCPropertyWithButton(float indent, SerializedProperty serializedProperty, GUIContent guiContent, GUIStyle buttonCompact, GUIContent btnContent, float defaultEditorLabelWidth, System.Action findAction)
        {
            EditorGUILayout.BeginHorizontal();
            float labelWidth = defaultEditorLabelWidth - 22f;
            if (indent > 0f)
            {
                DrawSSCLabelIndent(indent);
                labelWidth -= indent + 4f;
            ...
            if (GUILayout.Button(btnContent, buttonCompact, GUILayout.MaxWidth(20f)))
            {
                findAction();
            }
            EditorGUILayout.PropertyField(serializedProperty, GUIContent.none);
        ...
        /// <summary>
        /// Draw a info message in a helpbox
        /// </summary>
        /// <param name="indent"></param>
        /// <param name="infoMsg"></param>
        public static void DrawInfo(float indent, string infoMsg)
        {
            if (indent > 0)
            {
                GUILayout.BeginHorizontal();
        ...
        /// <param name="serializedProperty"></param>
        /// <param name="labelGUIContent"></param>
        public static void DrawSSCLayer(float indent, SerializedProperty serializedProperty, GUIContent labelGUIContent, float defaultLabelWidth)
        {
            GUILayout.BeginHorizontal();
            ...
            EditorGUILayout.LabelField(labelGUIContent, GUILayout.Width(labelWidth));
            serializedProperty.intValue = EditorGUILayout.LayerField(serializedProperty.intValue);

            GUILayout.EndHorizontal();
        }

        /// <summary>
        /// Draw a warning in the inspector to indicate Sticky3D Controller does not appear to be installed in the project
        /// </summary>
        public static void DrawSticky3DNotInstalled()
        {
            EditorGUILayout.HelpBox("Sticky3D Controller does not seem to be installed", MessageType.Error);
        }
        ...
        /// <summary>
        /// Draw a warning message in a helpbox
        /// </summary>
        /// <param name="indent"></param>
        /// <param name="warningMsg"></param>
        public static void DrawWarning(float indent, string warningMsg)
        {
            if (indent > 0)
            {
                GUILayout.BeginHorizontal();
        ...
        /// <summary>
        /// Get the current (active) build target group.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get the build target group that the user has selected (displayed) in the
        /// Project Settings window. NOTE: This may not be the active platform.
        /// See also GetActiveBuildTargetGroup().
        /// </summary>
        /// <returns></returns>
        public static BuildTargetGroup GetSelectedBuildTargetGroup()
        {
