...
namespace SciFiShipController
{
    ...
    public class SSCTargetable : MonoBehaviour
    {
        ...
        public virtual void Initialise()
        {
            if (!isInitialised)
            {
                // Make sure this is NOT a ship, surface turret, or Destructible Object.
                ShipControlModule shipControlModule;
                SurfaceTurretModule surfaceTurretModule;
                DestructibleObjectModule destructibleObjectModule;
                ...
                else if (TryGetComponent(out surfaceTurretModule))
                {
                    #if UNITY_EDITOR
                ...
                else if (TryGetComponent(out destructibleObjectModule))
                {
                    #if UNITY_EDITOR
