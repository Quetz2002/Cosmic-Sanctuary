...
namespace SciFiShipController
{
    ...
    public class SSCMovingPlatform : MonoBehaviour
    {
        ...
        /// <summary>
        /// Attempt to mute the audio
        /// </summary>
        public void MuteAudio()
        {
            if (isInitialised)
            {
                if (isAudioAvailable && platformAudio != null)
                {
                    platformAudio.mute = true;
                }
            }
            else if (platformAudio != null)
            {
                platformAudio.mute = true;
            }
        }
