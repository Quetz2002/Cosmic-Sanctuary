...
namespace SciFiShipController
{
    ...
    public class SurfaceTurretModule : MonoBehaviour
    {
        ...
        private void OnDestroy()
        {
            if (isInitialised)
            {
                // If there are DamageReceiver components attached, unsubscribe to the callback.
                ...
                {
                    DamageReceiver.tempDamageReceiverList[drIdx].callbackOnHit -= TakeDamage;
                }
        ...
        public void Initialise()
        {
            ...
            if (!isInitialised)
            {
                ...
                if (weapon != null)
                {
                    ...
                    {
                        // If there are DamageReceiver components attached, subscribe to the callback.
                        DamageReceiver.tempDamageReceiverList.Clear();
        ...
        /// <summary>
        /// [INTERNAL ONLY]
        /// When DamageReceiver component is attached, this routine is called by Sci-Fi Ship Controller when a projectile or beam hits it.
        /// It can also take damage from SSC X Pack 1 mines and missiles.
