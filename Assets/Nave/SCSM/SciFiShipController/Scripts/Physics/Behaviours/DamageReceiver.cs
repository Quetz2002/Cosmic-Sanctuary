...
namespace SciFiShipController
{
    ...
    public class DamageReceiver : MonoBehaviour
    {
        ...
        /// <summary>
        /// Subscribe to this to get notified immediately after the object is hit
        /// by a projectile or beam. It can also be called after receiving damage
        /// from a missile or mine from SSC X Pack 1. Your method must take 1
