...
namespace SciFiShipController
{
    ...
    public class CelestialsEditor : Editor
    {
        ...
        protected readonly static GUIContent isVRContent = new GUIContent(" VR", "The sky material to render the stars uses a custom URP shader");
        #endregion
        ...
        #region GUIContent - URP
        #if SSC_URP
        protected readonly static GUIContent skyMaterialURPContent = new GUIContent(" Sky Material", "The URP custom stars material to render the sky in VR");
        #endif
        #endregion

        #region GUIContent - HDRP or URP VR
        #if SSC_HDRP || SSC_URP
        ...
        protected SerializedProperty isVRProp;
        #endregion
        ...
        #region Serialized Properties - URP
        #if SSC_URP
        protected SerializedProperty skyMaterialURPProp;
        #endif
        #endregion

        #region Serialized Properties - HDRP or URP VR
        #if SSC_HDRP || SSC_URP
        ...
        public virtual void OnEnable()
        {
            ...
            isVRProp = serializedObject.FindProperty("isVR");
            #endregion
            ...
            #region Find Properties - HDRP or URP VR
            #if SSC_HDRP || SSC_URP
            ...
            #region Find Properties - URP only
            #if SSC_URP
            skyMaterialURPProp = serializedObject.FindProperty("skyMaterialURP");
            #endif
            #endregion
        }
        ...
        protected virtual void DrawCustomShaderSettings()
        {
        ...
        protected virtual void DrawGeneralSettings()
        {
            ...
            EditorGUILayout.HelpBox("Celestials for HDRP requires U2022.3+ and HDRP 14.x+", MessageType.Error);
            #endif
            ...
            #elif SSC_URP
            if (isVRProp.boolValue)
            {
                EditorGUILayout.PropertyField(initialiseOnAwakeProp, initialiseOnAwakeContent);
                EditorGUILayout.PropertyField(skyMaterialURPProp, skyMaterialURPContent);

                // Check skybox material
                if (skyMaterialURPProp.objectReferenceValue != null)
                {
                    if (RenderSettings.skybox == null || RenderSettings.skybox != skyMaterialURPProp.objectReferenceValue as Material)
                    {
                        GUILayout.BeginHorizontal();
                        EditorGUILayout.HelpBox("The Lighting Skybox material does not match the star material", MessageType.Warning, true);
                        if (GUILayout.Button("Fix Now", GUILayout.MaxHeight(36f)))
                        {
                            RenderSettings.skybox = skyMaterialURPProp.objectReferenceValue as Material;
            ...
            EditorGUILayout.PropertyField(isVRProp, isVRContent);
            #else
            DrawDefaultInspector(); 
            #endif
        }
