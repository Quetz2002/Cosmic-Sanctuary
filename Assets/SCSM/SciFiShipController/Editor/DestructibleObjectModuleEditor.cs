...
namespace SciFiShipController
{
    ...
    public class DestructibleObjectModuleEditor : Editor
    {
        ...
        private readonly static GUIContent useDamageMultipliersContent = new GUIContent("Use Damage Multipliers", "Whether damage type multipliers are used when calculating damage from projectiles or beams (or missiles and mines from X Pack 1)");
        private readonly static GUIContent typeADamageMultiplierContent = new GUIContent(" Damage Type A", "The relative amount of damage a Type A projectile or beam will inflict on the object.");
        private readonly static GUIContent typeBDamageMultiplierContent = new GUIContent(" Damage Type B", "The relative amount of damage a Type B projectile or beam will inflict on the object.");
        private readonly static GUIContent typeCDamageMultiplierContent = new GUIContent(" Damage Type C", "The relative amount of damage a Type C projectile or beam will inflict on the object.");
        private readonly static GUIContent typeDDamageMultiplierContent = new GUIContent(" Damage Type D", "The relative amount of damage a Type D projectile or beam will inflict on the object.");
        private readonly static GUIContent typeEDamageMultiplierContent = new GUIContent(" Damage Type E", "The relative amount of damage a Type E projectile or beam will inflict on the object.");
        private readonly static GUIContent typeFDamageMultiplierContent = new GUIContent(" Damage Type F", "The relative amount of damage a Type F projectile or beam will inflict on the object.");
