...
namespace SciFiShipController
{
    ...
    public class SSCRadarEditor : Editor
    {
        ...
        private readonly static GUIContent showUIOnInitContent = new GUIContent("Show UI on Init", "If there is an on-screen radar UI, show it when the radar initialises");
        ...
        private SerializedProperty showUIOnInitProp;
        ...
        private void OnEnable()
        {
            ...
            showUIOnInitProp = serializedObject.FindProperty("showUIOnInit");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (visualsShowInEditorProp.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(showUIOnInitProp, showUIOnInitContent);
