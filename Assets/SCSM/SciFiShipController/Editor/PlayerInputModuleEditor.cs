...
using UnityEngine;
using UnityEditor;
using static SciFiShipController.PlayerInputModule;
...
namespace SciFiShipController
{
    ...
    public class PlayerInputModuleEditor : Editor
    {
        ...
        private readonly static GUIContent xrTrackingOriginModeContent = new GUIContent(" Tracking Origin Mode", "For flight sitting position, set to Device and move the XR Camera to the initial starting position within the ship at design time in the editor. Default to floor for backward compatibility.");
        private readonly static GUIContent isRecentreOnInitXRContent = new GUIContent(" Recentre on Init", "Attempt to recentre the XR headset when it is initialised.");
        ...
        private SerializedProperty xrTrackingOriginModeProp;
        private SerializedProperty isRecentreOnInitXRProp;
        ...
        public void OnEnable()
        {
            ...
            xrTrackingOriginModeProp = serializedObject.FindProperty("xrTrackingOriginMode");
            isRecentreOnInitXRProp = serializedObject.FindProperty("isRecentreOnInitXR");
        ...
        public override void OnInspectorGUI()
        {
            ...
            else if (inputModeProp.intValue == (int)PlayerInputModule.InputMode.UnityXR && !isRefreshing)
            {
                ...
                EditorGUILayout.LabelField(string.IsNullOrEmpty(openXRVersion) ? xrPluginNotInstalled : openXRVersion);
                EditorGUILayout.EndHorizontal();
                ...
                else
                {
                    ...
                    EditorGUILayout.PropertyField(xrTrackingOriginModeProp, xrTrackingOriginModeContent);
                    EditorGUILayout.PropertyField(isRecentreOnInitXRProp, isRecentreOnInitXRContent);
