...
namespace SciFiShipController
{
    ...
    public class SampleObstacleSpawner : MonoBehaviour
    {
        ...
        [Range(0f, 10f)] public float rotationRateMin = 0.1f;
        [Range(0f, 10f)] public float rotationRateMax = 1.0f;
        ...
        public void Initialise()
        {
            ...
            if (numObstaclePrefabs > 0)
            {
                ...
                if (rotationRateMin < 0f) {  rotationRateMin = 0f; }
                if (rotationRateMax < rotationRateMin) { rotationRateMax = rotationRateMin; }
                ...
                for (int i = 0; i < obstacles; i++)
                {
                    ...
                    float rotationRate = UnityEngine.Random.Range(rotationRateMin, rotationRateMax);
