...
namespace SciFiShipController
{
    ...
    public class SampleHUDTargets : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (TryGetComponent(out playerShip))
            {
            ...
            if (sscRadar != null && playerShip != null && playerShip.IsInitialised)
            {
                ...
                for (int eIdx = 0; eIdx < 4; eIdx++)
                {
                    ...
                    if (enemyGO != null)
                    {
                        ...
                        damageReceiver = enemyGO.AddComponent<DamageReceiver>();
                    ...
                    if (dtIdx < numEnemy && nextBlipIndex >= 0)
                    {
                        ...
                        if (nextBlipIndex >= 0)
                        {
                            ...
                            if (nextWeaponIndex >= 0)
                            {
                                ...
                                if (nextWeaponIndex >= 0)
                                {
                                    // This is just one possible way you could do things. You could also investigate using other methods like
