...
namespace SciFiShipController
{
    ...
    public class SSCRadar : MonoBehaviour
    {
        ...
        /// <summary>
        /// If there is an on-screen radar UI, show it when the radar initialises
        /// </summary>
        public bool showUIOnInit = true;
        ...
        private void Start()
        {
            if (initialiseOnStart)
            {
                ...
                //if (isInitialised && isRadarImageAvailable && showUIOnInit)
                //{
                //    ShowUI();
                //}
            }
