...
namespace SciFiShipController
{
    ...
    public class ShipDocking : MonoBehaviour
    {
        ...
        /// <summary>
        /// [READ ONLY]
        /// Is the ship currently docked?
        /// </summary>
        public bool IsDocked { get => IsInitialised ? dockingStateInt == dockingInt : dockingState == DockingState.Docked; }

        /// <summary>
        /// [READ ONLY]
        /// Is the ship currently docking?
        /// </summary>
        public bool IsDocking { get => IsInitialised ? dockingStateInt == dockingInt : dockingState == DockingState.Docking; }

        /// <summary>
        /// [READ ONLY]
        /// Is the ship currently undocking?
        /// </summary>
        public bool IsUnDocking { get => IsInitialised ? dockingStateInt == undockingInt : dockingState == DockingState.Undocking; }

        /// <summary>
        /// [READ ONLY]
        /// Is the ship currently not docked? This includes neither docking or undocking.
        /// </summary>
        public bool IsNotDocked { get => IsInitialised ? dockingStateInt == notDockedInt : dockingState == DockingState.NotDocked; }
        ...
        public void Initialise()
        {
            if (!IsInitialised)
            {
                ...
                {
                    TryGetComponent(out shipAIInputModule);
                ...
                if (dockingStateInt == dockingInt)
                {
                    ...
                    if (shipAIStateID == AIState.dockingStateID)
                    {
                        ...
                        if (Vector3.SqrMagnitude(shipAIInputModule.GetTargetPosition() - targetDockingPos) < landingDistancePrecision * landingDistancePrecision)
                        {
                            ...
                            // Are there any Post Docked event peristent AND/OR non-persistent listeners?
        ...
        public void SetState (DockingState dockingState)
        {
            ...
            if (shipControlModule != null)
            {
                ...
                if (dockingStateInt == dockedInt && shipDockingStation != null)
                {
                    ...
                    // +SMS v1.5.6
                    // ShipAI docking already calls onPostDocked events in AICompletedStateActionCallback(..).
                    if (!isInAIDockingState && previousDockingStateInt == notDockedInt)
                    {
                        // Are there a onPostDocked event peristent AND/OR non-persistent listeners?
                        if (SSCUtils.HasListeners(onPostDocked))
                        {
                            if (onPostDockedDelay > 0f)
                            {
                ...
                {
                    // Are there Post Undocking Start event peristent AND/OR non-persistent listeners?
        ...
        {
            StopCoroutine(nameof(OnPostDockedDelayed));
        }
        ...
        {
            StopCoroutine(nameof(OnPostDockingHoverDelayed));
        }
        ...
        {
            StopCoroutine(nameof(OnPostDockingStartDelayed));
        }
        ...
        {
            StopCoroutine(nameof(OnPostUndockedDelayed));
        }
        ...
        {
            StopCoroutine(nameof(OnPostUndockingHoverDelayed));
        }
        ...
        {
            StopCoroutine(nameof(OnPostUndockingStartDelayed));
        }
